...
const EditItemModal: React.FC<{
  ...
  item: Item | null;
  onClose: () => void;
  onUpdate: (id: number, item: Omit<Item, "id">) => Promise<void>;
  categories?: Category[];
}> = ({ visible, item, onClose, onUpdate, categories = [] }) => {
  ...
  return (
    <Modal title="Edit Item" open={visible} onCancel={onClose} footer={null} width={700} style={{ borderRadius: '4px', top: 40 }}>
